...
const (
	ParserService_Get_FullMethodName = "/parser.ParserService/Get"
)
...
type ParserServiceClient interface {
	Get(ctx context.Context, in *ParserRequest, opts ...grpc.CallOption) (*ParserResponse, error)
}
...
func (c *parserServiceClient) Get(ctx context.Context, in *ParserRequest, opts ...grpc.CallOption) (*ParserResponse, error) {
	out := new(ParserResponse)
	err := c.cc.Invoke(ctx, ParserService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParserServiceServer interface {
	Get(context.Context, *ParserRequest) (*ParserResponse, error)
...
func (UnimplementedParserServiceServer) Get(context.Context, *ParserRequest) (*ParserResponse, error) {
...
func _ParserService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParserServiceServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ParserService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParserServiceServer).Get(ctx, req.(*ParserRequest))
	}
...
var ParserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Get",
			Handler:    _ParserService_Get_Handler,
		},
	},
